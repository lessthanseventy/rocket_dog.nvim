...
local colors = require("rocket_dog.colors")
...
function M.setup()
  ...
  theme.highlights = {
      ...
      -- TSConstMacro        = { };    -- For constants that are defined by macros: `NULL` inc.
      ...
      ["@operator"] = { fg = c.blue5 }, -- For any operator: `+`, but also `->` and `*` inc.
      ...
      NavicIconsNamespace = { fg = c.cyan, bg = c.none },
      ...
      NavicIconsVariable = { fg = c.yellow, bg = c.none },
      ...
      NavicIconsKeyword = { fg = c.red, bg = c.none },
