local ts = require("rocket_dog.treesitter")
...
function M.invert_color(color)
  local hsluv = require("rocket_dog.hsluv")
  if color ~= "NONE" then
...
function M.onColorScheme()
  vim.cmd([[autocmd! rocket_dog]])
  vim.cmd([[augroup! rocket_dog]])
end
...
function M.autocmds(config)
  vim.cmd([[augroup rocket_dog]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorSchemePre * lua require("rocket_dog.util").onColorScheme()]])
